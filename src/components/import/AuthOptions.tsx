  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="w-full card bg-[#232323] text-white hover:bg-[#333] transition-colors flex items-center justify-center gap-3"
        disabled={isLoading}
      >
      ...
      <p className="text-center text-sm text-[#232323]/60">
        Profile at <span className="font-mono">/@username</span> • Sync again
        anytime
      </p>
      ...
      <p className="text-center text-sm text-[#232323]/60">
        Profile at <span className="font-mono">/u/abc123</span> • Add name &
        company manually
      </p>
    </div>
  );
