...
import { GitHubStatsSection } from "@/components/dashboard/GitHubStatsSection";
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <header className="flex flex-wrap items-center justify-between gap-3 mb-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            <a
              href="https://github.com/lfglabs-dev/vibetracking.dev"
              target="_blank"
        ...
        {stats ? (
          <>
            ...
            {/* Row 2: GitHub Stats */}
            <div className="mb-6">
              <GitHubStatsSection username={user.username} />
            </div>

            {/* Row 3: Highlights + Insights (2 cards) */}
            ...
            {/* Row 4: Usage by Tool + Usage by Model (2 charts) */}
            ...
            {/* Row 5: Token Breakdown + Cost Trend (2 charts) */}
            {tokenUsage.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            {/* Row 6: Time of Day Heatmap (full width) */}
            {dailyActivity.length > 0 && (
              <div className="mb-6">
            ...
            {/* Row 7: Model Migration Timeline (full width) */}
            {tokenUsage.length > 0 && (
              <div className="mb-6">
            ...
            {/* Row 8: Fun Comparison (full width) */}
