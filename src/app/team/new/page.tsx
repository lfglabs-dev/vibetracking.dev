...
export default function NewTeamPage() {
  ...
  useEffect(() => {
    if (authState === "has_org_access" && orgs.length > 0 && !selectedOrg) {
      setSelectedOrg(orgs[0].login);
    }
  }, [authState, orgs, selectedOrg]);
          ...
          <div className="card">
            ...
            {authState === "not_logged_in" && (
              <div className="text-center py-4">
                ...
                <button
                  onClick={handleLogin}
                  className="mx-auto flex items-center justify-center h-12 w-12 rounded-full border border-[#232323]/10 hover:bg-[#232323]/5 transition"
            ...
            {authState === "has_org_access" && orgs.length > 0 && (
              <div className="space-y-4">
                <p className="text-center text-[#232323]/60 text-sm">
                  Confirm the organization for your team.
                </p>
                {(() => {
                  const org = orgs.find((o) => o.login === selectedOrg) ?? orgs[0];
                  return (
                    <div className="w-full flex items-center gap-3 p-3 rounded-lg border-2 border-[#AAE7C0] bg-[#AAE7C0]/10">
                      <img
                        src={org.avatar_url}
