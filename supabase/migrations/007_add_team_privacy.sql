...
DROP POLICY IF EXISTS "Team stats are viewable by everyone" ON team_stats;
...
DROP POLICY IF EXISTS "Team memberships are viewable by everyone" ON team_memberships;
